...
(DEFAULT,'U11','점토 개인농장 100단위로 12,000원에 팔기',CURRENT_TIMESTAMP()),
(DEFAULT,'U23','소금구이 모두 51,000원에 팔기',CURRENT_TIMESTAMP()),
(DEFAULT,'U23','다랑어 올리브 스테이크 모두 21,000원에 팔기',CURRENT_TIMESTAMP()) ;
