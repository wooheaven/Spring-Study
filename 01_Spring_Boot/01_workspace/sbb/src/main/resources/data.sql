...
(DEFAULT,'U23','프프란 트리 모두 240,000원에 팔기',                          CURRENT_TIMESTAMP()),
(DEFAULT,'U23','다랑어 올리브 스테이크 모두 27,000원에 팔기',                CURRENT_TIMESTAMP()),
(DEFAULT,'U23','소금구이 모두 6,600원에 팔기',                               CURRENT_TIMESTAMP()),
...
(DEFAULT,'U24','남만무역 가격 확인하기 : 조선차, 일본도',                    CURRENT_TIMESTAMP()),
...
(DEFAULT,'U35','캐슈넛 100% 이상이면 기묘한 열매 5단위로 U23 에게 전달하기', CURRENT_TIMESTAMP()),
(DEFAULT,'U35','풋고후 100% 이상이면 기묘한 열매 6단위로 U23 에게 전달하기', CURRENT_TIMESTAMP()),
(DEFAULT,'U35','사이잘마 가격 확인하기',                                     CURRENT_TIMESTAMP()),
(DEFAULT,'U35','남만무역 가격 확인하기 : 초롱, 동권총, 명주',                CURRENT_TIMESTAMP()),
-- U36
(DEFAULT,'U36','보석 제품 가격 확인하기',                                    CURRENT_TIMESTAMP()),
(DEFAULT,'U36','나무열매 전부 U23 에게 전달하기',                            CURRENT_TIMESTAMP())
;